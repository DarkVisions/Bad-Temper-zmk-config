...
This is my hack of a ZMK config for the [Bad Temper](https://github.com/essFitt/Bad-Temper) low-profile egonomic keyboard by [EssFit](https://github.com/essFitt).
...
- Navigation layer has inverted-T arrow keys.
- Current layout is visible visually below, due to the keymap drawer code.
- It's a work in progress: I'm used to QMK, and this is a learning experience.
